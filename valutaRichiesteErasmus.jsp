<!--
Pagina per l'impiegato; Pagina che comprende una lista di tutti i moduli di accettazione che hanno inviato gli studenti
-->
	...
	<body>
		...
		<div id="corpo">
			...
			<div id="contenuto">
				...
				<div id="testoTriste"> 
					Non ci sono richieste Erasmus da valutare.
					<br> <br> 
				</div>
					<%	}else{ %>
				...
				<div id="boxDomanda">
					...
					<a href="control?action=caricaModulo&idModulo=<%= moduli.get(i).getID() %>&page=/valutaRichiesta.jsp">
