<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div id="ColonnaSx">
		...
		<a href="login.jsp"><button 
			...
			id="tastoAccediLaterale"> <i class="fa fa-sign-in" style="font-size:28px;color:#FF6633; margin-right:3px;margin-left:5px;vertical-align: middle;" aria-hidden="true"> </i> Accedi
...
    			<li id="LeftText"> <i class="fa fa-home" style="font-size:26.5px;color: red; margin-top: -5px; margin-right:3px; margin-left:4.5px; vertical-align: middle;" aria-hidden="true"> </i> <a href="control?action=redirect&page=/homeStudenti.jsp"> Home</a> </li>
    ...
    <a href="login.jsp"><button 
			...
			id="tastoAccediPortrait"> <i class="fa fa-sign-in" style="font-size:29px;color:#FF6633; margin-right:3px;margin-left:5px;vertical-align: middle;" aria-hidden="true"> </i> Accedi 
