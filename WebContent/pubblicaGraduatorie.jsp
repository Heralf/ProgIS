<!--
Pagine dell'impiegato; Serve a caricare nel database la graduatoria.
-->
		...
		<div id="corpo">
			...
			<div id="contenuto">
				<div id="boxGraduatorie">
					...
					<br> <br> 	
					<%	if(caricato){ %><label style="font-size:bold;color:red;">La graduatoria &egrave; gia stata caricata, 
						il ricaricamento la sostituir&agrave;</label> <%	} %>	
					<form method="post" action="control" enctype="multipart/form-data">
         				<table border="0">
             			<tr>
                  		 	<td>
                  		  		<label  id ="pulsanteCarica">
                  		 			<i class="fa fa-cloud-upload" style="font-size:26px; color:#2ecc71; margin-top:-5px;
                  		 				margin-right:2px; vertical-align:middle;" aria-hidden="true">
                  		 			</i>
                		...
                		<br>
               			 <tr>
                    		<td colspan="2">
                       			<button  id ="pulsantePubblica" type="submit" name="action" value="caricaGraduatoria">
