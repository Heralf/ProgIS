<!--
Pagina per l'impiegato; Serve a valutare una domanda inviata dallo studente da parte dell'impiegato
-->
		...
		<div id="corpo">
			...
			<div id="contenuto">
				<div id="testoCompilaDomanda"> 
					...
					il modulo di accettazione (lo studente verr&agrave; notificato e invitato a ricompilare tale modulo).	
		 			<br> <br>	
					...
					<br>
  					...
  					<br>
  					<p id="inputEtichetta"> Destinazione:	<%= modulo.getDestinazione1() %>	
  					<br>
  					<p id="inputEtichetta"> Carta di Identit&agrave;:	<%= modulo.getCartaIdentita() %>	
  					<br>
