		...
		<div id="contenuto">		
			...
			<form action="product" method="post">		
				Accedi inserendo le tue credenziali universitarie.<br><br>			
			 	...
			 	<p id="inputEtichetta"> Password:<br>
  			 	<input id="inserisciTesto" type="password" name="password" required><%	if(errore!=null&&!errore){ %> <font color="red">	Password Errata </font>	<%	} %><br>			 
				<button 
					id="tastoLogin" type="submit" name="action" value="login"> <i class="fa fa-sign-in" style="font-size:28px;color:#FF6633; margin-right:3px;margin-left:5px;vertical-align: middle;" aria-hidden="true"> </i> Accedi
     			</button>
     		</form>
			</div>
		</div>
