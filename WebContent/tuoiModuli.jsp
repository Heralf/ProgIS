	...
	<body>
		...
		<div id="corpo">
			...
			<div id="contenuto">
				...
				<div id="testoTriste"> 
					Non hai ancora nessun modulo di accettazione da compilare.
					<br> <br>
					Stiamo facendo il possibile per controllare tutte le domande Erasmus, ed anche le tue, nel caso tu ne abbia inviate.
					<br> <br>
				</div>
				<% }else{ %>
				<div id="testoRichiesteErasmus">
					...
					modulo di accettazione dell&rsquo;Erasmus che pi&ugrave; ti interessa.
					<br> <br>
				...
				<div id="boxDomanda">
					...
					<button id="tastoModuli1" onclick="location.href='control?action=caricaModulo&idModulo=<%= moduli.get(i).getID() %>
					        &page=/compilaModulo.jsp'" <% if(moduli.get(i).getInviaModulo()) { %> disabled=”disabled” <% } %> 
