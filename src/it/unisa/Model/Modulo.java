...
public class Modulo{
	...
	public synchronized void creaModulo (ModuloBean modulo, Boolean domanda, Boolean inviato) throws SQLException{
		...
		String inserisciSQL ;
		if(domanda)
			inserisciSQL = "INSERT INTO "+ Modulo.TABLE_NAME + " (IDPROPRIETARIO, NOME, COGNOME, SESSO, DATANASCITA, DATA, POSTAELETTRONICA, MATRICOLA, CITTANASCITA, CITTARESIDENZA, INDIRIZZO, NUMEROCIVICO, CAP, NUMEROTELEFONICO, DESTINAZIONE1, DESTINAZIONE2, DESTINAZIONE3, DOMANDA, INVIAMODULO) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		else
			inserisciSQL = "INSERT INTO "+ Modulo.TABLE_NAME + " (IDPROPRIETARIO, NOME, COGNOME, SESSO, DATANASCITA, DATA, POSTAELETTRONICA, MATRICOLA, CITTANASCITA, CITTARESIDENZA, INDIRIZZO, NUMEROCIVICO, CAP, NUMEROTELEFONICO, DESTINAZIONE1, CARTAIDENTITA , DOMANDA, INVIAMODULO) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		try{
	...
	public synchronized void aggiornaModulo (int idModulo, ModuloBean modulo, Boolean domanda, Boolean inviato) throws SQLException{
		...
		String aggiornaSQL;
		if(domanda)
			aggiornaSQL = "UPDATE "+ Modulo.TABLE_NAME + " SET DESTINAZIONE1 = ?, DESTINAZIONE2 = ?, DESTINAZIONE3 = ?, INVIAMODULO = ? WHERE ID = ?";
		else
