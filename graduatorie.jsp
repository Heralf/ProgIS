...
<!--
		<div id="boxGraduatorie">
			...
			<a href=""><button 
				id="tastoGraduatorie"> <i class="fa fa-download" style="font-size:24px;color:#3399FF;
					margin-right:3px;margin-left:4px; margin-bottom: 3px; vertical-align: middle;" aria-hidden="true"> </i> Scarica
     		</button></a>
     	</div>
	-->
